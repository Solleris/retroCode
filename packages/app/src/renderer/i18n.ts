...
const DICT: Record<string, Entry> = {
  ...
  "lens.focusTitle":    { pt: "clica → foca o pane que roda esta sessão",
                          en: "click → focus the pane running this session" },
  "lens.resume":        { pt: "retomar", en: "resume" },
  "lens.resumeTitle":   { pt: "abre um terminal novo rodando claude --resume nesta sessão",
                          en: "opens a new terminal running claude --resume on this session" },
